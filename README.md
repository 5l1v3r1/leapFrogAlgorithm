...
###findClosest()
This is the "Leap Frog" algorithm that I was able to come up with. I call it the "Leap Frog" because of the way in which the algorithm leaps back and forth over the value, incrementing and decrementing, until a match is found to the, either incremented or decremented, value in the second sequence.
